...
| FR-010 | PDF p.3-4 total expected repayments | UC-004; SSD-001; OC-006; DSD-006; `docs/07-design/class-diagram.md` MortgageCalculator/FundsAvailabilityCalculator; `docs/03-requirements/software-requirements-specification.md` OI-REQ-002 | TC-CALC-007 | Open / Needs Discussion |
...
| FR-012 | PDF p.4 amount available | UC-004; SSD-001; OC-006; DSD-006; `docs/07-design/class-diagram.md` FundsAvailabilityCalculator; `docs/03-requirements/software-requirements-specification.md` BR-009 | TC-CALC-009 | Design Complete |
